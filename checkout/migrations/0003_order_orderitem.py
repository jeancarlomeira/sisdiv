# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-30 12:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('checkout', '0002_auto_20160922_1834'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_option', models.CharField(choices=[('pagseguro', 'PagSeguro'), ('paypal', 'Paypal')], max_length=20, verbose_name='Opção pagamento')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('modeified', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
